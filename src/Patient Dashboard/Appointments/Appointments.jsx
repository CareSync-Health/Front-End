      ...
      <div className='flex-1 lg:h-[99.9vh] xs:h-[85vh] overflow-y-auto bg-[#FFFCF8]' style={{ msOverflowStyle: 'none', scrollbarWidth: 'none' }}>
        ...
        <div className='mt-[3rem] xs:px-[10px] lg:px-[30px]'>
          <div className='flex items-center lg:justify-between xs:justify-end'>
            ...
            <Link to='' className='bg-[#22D1EE] w-[270px] rounded-[6px] py-[10px] px-[15px] text-[#fff] text-[18px] font-medium font-Mulish flex items-center justify-between'>New Appointment <FaPlus /></Link>
          </div>
          {/* TABLE */}
