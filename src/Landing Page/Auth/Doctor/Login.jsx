...
const Login = () => {
  ...
  const submitHandler = (e) => {
    ...
    dispatch(doctor_login(body, navigate));
  };
        ...
        <div className='lg:flex justify-between gap-[10rem]'>
            ...
            <div className='shadow-xl bg-[#fff] lg:w-[518px] xs:w-full px-[20px] py-[15px] lg:mt-0 xs:mt-[5rem] lg:rounded-[8px]'>
                ...
                <form onSubmit={submitHandler}>
                    ...
                    <input value={email} onChange={(e) => setEmail(e.target.value)} type="email" className='lg:w-[456px] xs:w-full px-[10px] py-[10px] mt-[10px] rounded-[8px] border-[0.5px] opacity-[40%] bg-transparent text-[#000] text-[17px] mb-[1rem]' required />
                    <label className='text-[#000] text-[17px] font-[600]'>Password</label><br/>
                    <input value={password} onChange={(e) => setPassword(e.target.value)} type="password" className='lg:w-[456px] xs:w-full px-[10px] py-[10px] mt-[10px] rounded-[8px] border-[0.5px] opacity-[40%] bg-transparent text-[#000] text-[17px]' required />
                    <button type='submit' className='bg-[#17B978] lg:w-[150px] xs:w-full py-[10px] rounded-[8px] px-[10px] text-center text-[#fff] font-[500] lg:ms-[9rem] mt-[1.5rem]'>Sign In</button>
                    <center>
