        ...
        <div style={{ backgroundImage: `url(${img})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }} className='h-screen'>
            <div className='flex items-center justify-center h-full'>
                <div className='mt-[4rem]'>
                        ...
                        <form className='mt-[2rem]' onSubmit={handleSubmit}>
                            <label className='block relative'>
                                ...
                                <input
                                    ...
                                    disabled={loading}
                                    required
                                    className='pl-10 pr-4 py-2 w-full border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#17B978] focus:border-transparent'
                                />
                            </label>
                    ...
                    <h2 className='mt-[5rem] text-center font-Inter font-normal text-[#fff]'>By logging in to CareSync Med, you agree to our <Link to='/terms&conditions' className='underline'>terms of service</Link>.</h2>
                </div>
            </div>
        </div>
    );
