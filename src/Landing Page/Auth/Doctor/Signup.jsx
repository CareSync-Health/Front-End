                ...
                <div className='shadow-xl bg-[#fff] lg:w-[518px] xs:w-full lg:mt-0 xs:mt-[5rem] px-[20px] py-[15px] lg:rounded-[8px]'>
                    ...
                    <form onSubmit={submitHandler}>
                        ...
                        <input
                            ...
                            type="text"
                            className='lg:w-[456px] xs:w-full px-[10px] py-[10px] mt-[10px] rounded-[8px] border-[0.5px] opacity-[100%] outline-none bg-transparent text-[#000] text-[17px] mb-[1rem]'
                            required
                        ...
                        <input
                            ...
                            type="password"
                            className='lg:w-[456px] xs:w-full px-[10px] py-[10px] mt-[10px] rounded-[8px] border-[0.5px] opacity-[100%] outline-none bg-transparent text-[#000] text-[17px]'
                            required
                            disabled={loading} // Disable input while loading
                        />
                        <button
                            type='submit'
                            className='bg-[#17B978] lg:w-[150px] xs:w-full py-[10px] rounded-[8px] px-[10px] text-center text-[#fff] font-[500] lg:ms-[9rem] mt-[1.5rem]'
                        ...
                        <center>
                            <div className='mt-5'>
                                <input type="checkbox" required className='bg-[#F6F6F6]' disabled={loading} />
                        ...
                        <div className="flex gap-2 shadow-lg border mt-[2rem] bg-white w-[100%] lg:px-[130px] xs:px-[65px] lg:py-[11px] xs:py-[15px] rounded-[8px] font-Roboto cursor-pointer">
                            ...
                            <h6 className='text-[17px] font-medium font-Inter'>Signup with Google</h6>
                        </div>
