...
import { verify_otp } from '../../../Redux/Actions/DoctorActions';
    ...
    <div className='bg-[#E2F3F5] w-full h-screen pb-4 lg:px-5'>
      ...
      <div className='lg:px-12 xs:px-4 lg:flex gap-32'>
        <div className='lg:w-1/2'>
          ...
          <p className='text-black opacity-50 text-lg font-light font-Poppins text-start leading-6 mt-6'>
          ...
          <p className='text-black text-lg font-normal font-Poppins mt-6 lg:ml-16 xs:ml-12'>
