  ...
  return (
    <div>
        ...
        <div style={{ backgroundImage: `linear-gradient(to bottom, rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url(${about})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }} className='h-[90vh] pt-[3rem] px-[10px]'>
            ...
            <p className='text-[#fff] lg:text-[22px] xs:text-[18px] font-Almarai font-normal text-center lg:w-[990px] lg:ms-[12rem] mt-[3rem]'>At CareSync med, we believe that managing your health should be seamless, empowering, and tailored to your needs. Our mission is to make healthcare easy for you, putting you in control of your well-being with the convenience of a single, user-friendly app.</p>
        </div>
        ...
        <div className='bg-[#E2F3F5] pb-[5rem] mt-[8rem] pt-[3rem] px-[10px]'>
          <h1 className='text-[#17B978] text-[50px] font-Yesteryear font-normal text-center'>Why CareSync Med?</h1>
          ...
          <div className='lg:px-[40px] xs:px-[10px] flex flex-wrap gap-[4rem] items-center mt-[5rem]'>
            <div className='bg-[#fff] lg:w-[590px] lg:h-[290px] xs:h-[350px] px-[30px] py-[20px]'>
            ...
            <div className='bg-[#fff] lg:w-[590px] lg:h-[290px] xs:h-[350px] px-[30px] py-[30px]'>
        ...
        <div>
          ...
          <div className='px-[10px] mt-[5rem] lg:ms-[8rem]'>
            <h2 className='text-[#181E4B] text-[30px] font-Volkhov font-bold'>Join the CareSync Med Community</h2>
