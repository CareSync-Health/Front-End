        ...
        <span>
          ...
          <label class="switch">
            <div class="toggle-switch relative w-[80px] h-[40px]">
              ...
              <label style={{background:`${check ? "linear-gradient(to right, #66bb6a, #43a047)" : 'linear-gradient(to right, #2e2e2e, #4a4a4a)'}`, transition:"background 0.3s"}} for="switch" className='absolute cursor-pointer before:absolute before:h-[36px] before:w-[36px] before:content-none top-0 left-0 right-0 bottom-0'></label>
            </div>
          </label>
        </span>
      </div>
