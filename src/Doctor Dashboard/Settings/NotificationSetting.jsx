          ...
          <label className="switch">
            <div className="toggle-switch relative w-[80px] h-[40px]">
              ...
              <label
                ...
                htmlFor="switch"
                className={`absolute top-0 left-0 right-0 bottom-0 cursor-pointer -full transition-all duration-300 before:absolute before:h-[36px] before:w-[36px] before:left-[2px] before:bottom-[2px] before:-full before:bg-[#fff] before:shadow-md before:transition-all before:duration-300 ${check ? 'before:translate-x-[40px] before:bg-[#66bb6a]' : ''}`}
              ></label>
            </div>
          </label>
        </span>
