          ...
          <label className="switch">
            <div className="toggle-switch relative w-[4rem] h-[1.8rem]">
              <input
                ...
                className="hidden"
              />
              <label htmlFor="switch" className={`border  border-[#17B978] absolute top-0 left-0 right-0 bottom-0 cursor-pointer rounded-lg transition-all duration-300 before:absolute before:h-[1.55rem] before:w-[1.55rem] before:left-[2px] before:bottom-[2px] before:rounded-lg before:bg-[#17B978] before:shadow-md before:transition-all before:duration-300 ${check ? 'before:translate-x-[2.15rem] before:bg-[#17B978]' : ''}`} ></label>
            </div>
          </label>
        </span>
        <span className='flex mt-8 justify-between items-center'>
          ...
          <label className="switch1">
            <div className="toggle-switch relative w-[4rem] h-[1.8rem]">
              <input
                ...
                className="hidden"
              />
              <label htmlFor="switch1" className={`border  border-[#17B978] absolute top-0 left-0 right-0 bottom-0 cursor-pointer rounded-lg transition-all duration-300 before:absolute before:h-[1.55rem] before:w-[1.55rem] before:left-[2px] before:bottom-[2px] before:rounded-lg before:bg-[#17B978] before:shadow-md before:transition-all before:duration-300 ${check1 ? 'before:translate-x-[2.15rem] before:bg-[#17B978]' : ''}`} ></label>
            </div>
          </label>
        </span>
        <span className='flex mt-8 justify-between items-center'>
          ...
          <label className="switch2">
            <div className="toggle-switch relative w-[4rem] h-[1.8rem]">
              <input
                ...
                className="hidden"
              />
              <label htmlFor="switch2" className={`border  border-[#17B978] absolute top-0 left-0 right-0 bottom-0 cursor-pointer rounded-lg transition-all duration-300 before:absolute before:h-[1.55rem] before:w-[1.55rem] before:left-[2px] before:bottom-[2px] before:rounded-lg before:bg-[#17B978] before:shadow-md before:transition-all before:duration-300 ${check2 ? 'before:translate-x-[2.15rem] before:bg-[#17B978]' : ''}`} ></label>
            </div>
          </label>
        </span>
          ...
          <label className="switch3">
            <div className="toggle-switch relative w-[4rem] h-[1.8rem]">
              <input
                ...
                className="hidden"
              />
              <label htmlFor="switch3" className={`border  border-[#17B978] absolute top-0 left-0 right-0 bottom-0 cursor-pointer rounded-lg transition-all duration-300 before:absolute before:h-[1.55rem] before:w-[1.55rem] before:left-[2px] before:bottom-[2px] before:rounded-lg before:bg-[#17B978] before:shadow-md before:transition-all before:duration-300 ${check3 ? 'before:translate-x-[2.15rem] before:bg-[#17B978]' : ''}`} ></label>
            </div>
          </label>
        </span>
