              ...
              <table className='w-full text-left text-xs'>
                <thead className=''>
                  <tr className='border-b'>
                    <th className='font-medium px-5 py-3 align-middle'>Name</th>
                    <th className='font-medium px-5 py-3 align-middle'>Email</th>
                    <th className='font-medium px-5 py-3 align-middle'>Date</th>
                    <th className='font-medium px-5 py-3 align-middle'>Visit Time</th>
                    <th className='font-medium px-5 py-3 align-middle'>Doctor</th>
                    <th className='font-medium px-5 py-3 align-middle'>Conditions</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className='border-b'>
                    <td className='flex gap-4 align-middle items-center py-2 px-5'>
