          ...
          <div className='px-[30px]'>
            ...
            <section className='bg-white rounded-md w-full mt-5'>
              ...
              <div className='p-5 flex'>
                <a href="" className='border p-[0.3rem] rounded-md bg-black'>
                  <svg className='w-2' height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g opacity="0.7">
                ...
                <a href="" className='border rounded-lg'>
