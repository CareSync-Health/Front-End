                ...
                <tbody>
                  {details.map((det, index) => (
                    <tr key={index} className='border-b'>
                      <td className='py-2 px-5 align-middle w-fit bg-black'><span className='flex gap-4 items-center w-fit'><img className='w-8' src={det.image} alt="" /><p>{det.name}</p></span></td>
