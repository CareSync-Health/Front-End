      ...
      <div className='flex-1 lg:h-[99.9vh]  xs:h-[85vh]  overflow-y-auto bg-[#E2F3F5]' style={{ msOverflowStyle: 'none', scrollbarWidth: 'none' }}>
        ...
        <div>
          ...
          <div className='px-[30px]'>
            ...
            <section className='bg-white rounded-md w-full mt-5 overflow-auto'>
                ...
                <tbody>
                  {details.map((det, index) => (
                    <tr key={index} className='border-b'>
                      <td className='py-2 px-5 align-middle '><span className='fledx gap-4 items-center'><img className='w-8' src={det.image} alt="" />{det.name}ddddddddddddddddddddddddddddd</span></td>
