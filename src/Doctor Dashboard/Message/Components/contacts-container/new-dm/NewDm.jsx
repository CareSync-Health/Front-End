    ...
    return (
        <>
            <div className='absolute lg:bottom-5 right-0 lg:text-[22px] xs:text-[25px] lg:left-[32rem] lg:block xs:flex items-end justify-end pr-[2rem]'>
                <TooltipProvider>
                    <Tooltip>
                        ...
                        <TooltipContent className={`ms-[-4rem] text-[12px] font-Nunito font-normal py-1 px-2 ${theme === 'dark' ? 'bg-gray-900' : theme === 'light' ? 'bg-[#E2F3F5]' : 'bg-gray-100'} ${appearance === 'green' ? 'text-[#17B978]' : appearance === 'blue' ? 'text-[#22D1EE]' : appearance === 'accent' ? 'text-[#A6FFF2]' : theme === 'dark' ? 'text-white' : 'text-gray-800'}`}>
                            Select New Contact
                        </TooltipContent>
                    </Tooltip>
                </TooltipProvider>
            ...
            <Dialog open={openNewContactModal} onOpenChange={setOpenNewContactModal}>
                <DialogContent className={`border-none lg:w-[400px] xs:w-[90%] h-[400px] flex flex-col ${theme === 'dark' ? 'bg-gray-800' : theme === 'light' ? 'bg-[#E2F3F5]' : 'bg-gray-100'} ${appearance === 'green' ? 'text-[#17B978]' : appearance === 'blue' ? 'text-[#22D1EE]' : appearance === 'accent' ? 'text-[#A6FFF2]' : theme === 'dark' ? 'text-white' : 'text-gray-800'}`}>
                    <DialogHeader>
                    ...
                    <div>
                        <input
                            ...
                            className={`w-full p-1.5  outline-none text-[14px] font-Nunito font-normal rounded-[10px] ${theme === 'dark' ? 'bg-gray-700' : theme === 'light' ? 'bg-[#E2F3F5]' : 'bg-gray-100'} ${appearance === 'green' ? 'text-[#17B978]' : appearance === 'blue' ? 'text-[#22D1EE]' : appearance === 'accent' ? 'text-[#A6FFF2]' : theme === 'dark' ? 'text-white' : 'text-gray-800'}`}
